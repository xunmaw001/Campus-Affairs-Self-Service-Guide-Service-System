    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="手机号" prop="jiaoshiPhone">
                       <el-input v-model="ruleForm.jiaoshiPhone"
                                 placeholder="手机号" clearable  :readonly="ro.jiaoshiPhone"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="手机号" prop="jiaoshiPhone">
                           <el-input v-model="ruleForm.jiaoshiPhone"
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jiaoshiPhoto" label="照片" prop="jiaoshiPhoto">
                        <file-upload
                            tip="点击上传照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiaoshiPhoto" label="照片" prop="jiaoshiPhoto">
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='jiaoshiName'){
                          this.ruleForm.jiaoshiName = obj[o];
                          this.ro.jiaoshiName = true;
                          continue;
                      }
                      if(o=='sexTypes'){
                      ...
                      if(o=='jiaoshiIdNumber'){
                          this.ruleForm.jiaoshiIdNumber = obj[o];
                          this.ro.jiaoshiIdNumber = true;
                          continue;
                      }
                      if(o=='jiaoshiPhone'){
                          this.ruleForm.jiaoshiPhone = obj[o];
                          this.ro.jiaoshiPhone = true;
                          continue;
                      }
                      if(o=='jiaoshiPhoto'){
                          this.ruleForm.jiaoshiPhoto = obj[o];
                          this.ro.jiaoshiPhoto = true;
                          continue;
                      }
                      if(o=='jiaoshiDelete'){
                          this.ruleForm.jiaoshiDelete = obj[o];
                          this.ro.jiaoshiDelete = true;
                          continue;
                      }
                    }
                }
